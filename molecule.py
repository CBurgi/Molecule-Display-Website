...
def xrotation(x_matrix, deg):
    return _molecule.xrotation(x_matrix, deg)
xrotation = _molecule.xrotation

def yrotation(y_matrix, deg):
    return _molecule.yrotation(y_matrix, deg)
yrotation = _molecule.yrotation

def zrotation(z_matrix, deg):
    return _molecule.zrotation(z_matrix, deg)
...
def nullMallocTest(ptr):
    return _molecule.nullMallocTest(ptr)
nullMallocTest = _molecule.nullMallocTest
